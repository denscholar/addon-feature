...
import 'package:uplanit_supplier/core/models/shared/category.dart';
...
import 'package:uplanit_supplier/core/models/shared/event_type.dart';
...
class BusinessProfileService {
  ...
  Future<Contact> updateContact(
      {@required String token, Contact contact}) async {
    try {
      var response = await apiRepository.request(
        requestType: RequestType.POST,
