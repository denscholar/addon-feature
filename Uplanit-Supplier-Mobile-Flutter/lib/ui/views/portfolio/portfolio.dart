            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: !model.loading ? Color(0XFFC20370) : Color(0XFFC20370).withOpacity(.4),
                ),
                child: model.loading
            ...
            children: [
              ...
              Padding(
                ...
                child: Stack(
                  children: [
                    RaisedButton(
                      onPressed: _portfolioModel.deletingImage
                          ? null
                          : () async {
                              ...
                              if (response != null) {
                                _portfolioModel
                                    .removePortfolio(portfolios[index]);
                                removeOverlay();
                                print('deleted');
                              }
                            },
                      color: CustomColor.primaryColor,
                      child: _portfolioModel.deletingImage
